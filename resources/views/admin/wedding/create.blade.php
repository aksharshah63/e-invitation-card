        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="{{ route('weddings.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Boy Name <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" required="required" type="text" name="boy_name" value="{{ old('boy_name') }}">
                                </div>
                            </div>
                            <!-- <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Boy Image <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6 image1" required="required" type="file" name="boy_image">
                                    <div id="preview-crop-image1" ></div>
                                </div>
                            </div> -->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Boy Image<span class="required">*</span></label>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="boy_instagram" value="{{ old('boy_instagram') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Facebook</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="boy_facebook" value="{{ old('boy_facebook') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Twitter</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="boy_twitter" value="{{ old('boy_twitter') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Pinterest</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="boy_pinterest" value="{{ old('boy_pinterest') }}">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" required="required" type="text" name="girl_name" value="{{ old('girl_name') }}">
                                </div>
                            </div>
                            <!-- <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Girl Image <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6 image2" required="required" type="file" name="girl_image">
                                    <div id="preview-crop-image2" ></div>
                                </div>
                            </div> -->
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Girl Image<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-6 col-xs-6" type="file" name="girl_image" required="required" id="girl_image">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 text-center">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Instagram</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="girl_instagram" value="{{ old('girl_instagram') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Facebook</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="girl_facebook" value="{{ old('girl_facebook') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Twitter</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="girl_twitter" value="{{ old('girl_twitter') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Pinterest</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-6 col-xs-6" type="text" name="girl_pinterest" value="{{ old('girl_pinterest') }}">
                                </div>
                            </div>
                            <div class="ln_solid"></div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        <input type="date" class="form-control col-md-6 col-xs-6" required="required" name="wedding_date" value="{{ old('wedding_date') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="ln_solid"></div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="banner_image" class="form-control col-md-6 col-xs-6" required="required" type="file" name="banner_image">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="invited_by_name" class="form-control col-md-6 col-xs-6" required="required" data-role="tagsinput" type="text" name="invited_by_name[]" value="{{ old('invited_by_name') }}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="invited_by_address">Address <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="invited_by_address" class="form-control col-md-6 col-xs-6" required="required" type="text" name="invited_by_address" value="{{ old('invited_by_address') }}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="invited_by_phone" class="form-control col-md-6 col-xs-6" required="required" type="text" data-role="tagsinput" name="invited_by_phone[]" value="{{ old('invited_by_phone') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="ln_solid"></div>
...
$('.upload-image2').on('click', function (ev) {
  resize2.croppie('result', {
    ...
    html = '<img src="' + img + '" /><input id="name" class="form-control col-md-6 col-xs-6" required="required" type="hidden" name="girl_image2" value="' + img +'">';
