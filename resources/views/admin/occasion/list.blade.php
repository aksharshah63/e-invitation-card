        ...
        <div class="page-title">
            ...
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <span class="input-group-btn text-right">
                            <a class="btn btn-default" href="{{ route('occasions.create',$id) }}" title="Create a Region">Add New Occasion</a>
                        </span>
                    </div>
                </div>
            </div>
                            ...
                            @php
                                ...
                                @foreach ($occasions as $occasion)
                                    <tr class="even pointer row1" data-id="{{ $occasion->id }}">
                                        ...
                                        @php
                                            $myDateTime = DateTime::createFromFormat('Y-m-d', $occasion->date);
                                            $formattedoccassiondate = $myDateTime->format('d-m-Y');
                                        @endphp
                                        <td class=" ">{{ $formattedoccassiondate }} </td>
                                        ...
                                        <td class=" "> <img src="{{ asset('images/'. $occasion->image)}}" height="100px" width="100px"> </td>
                                        @else

                                        <td class=" "> <img src="{{ \App\Utility::occasiongetImageUrl($occasion->image, $occasion->wedding_id)}}" height="100px" width="100px"> </td>
                                        @endif
                                        {{-- <td class=" "> <img src="{{ asset('images/'. $occasion->image)}}" height="100px" width="100px"> </td> --}}

                                        <td class=" ">
                                            <form action="{{ route('occasions.destroy', $occasion->id) }}" method="POST">
                                                <a href="{{ route('occasions.edit', $occasion->id) }}" class="btn btn-info">
