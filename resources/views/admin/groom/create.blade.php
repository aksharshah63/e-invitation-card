    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left" action="{{ route('groom.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a href="{{ route('groom.index',$id) }}"><button type="button" class="btn btn-primary">Cancel</button></a>
